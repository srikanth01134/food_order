...
from crud_app.views import catagory_view,display,updates,deletes,items_view,item_update,items_list,item_delete,non_view
app_name='crud_app'

urlpatterns=[
    path(route='',view=catagory_view,name='catagory_view'),
    ...
    path(route='non_view/',view=non_view,name='non_view'),
]