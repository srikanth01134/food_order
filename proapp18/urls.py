...
from proapp18.views import customer_register,login_view,home_view,logout_view,otp_view,start_view,hotel1_view,hotel_view,hotel_display,hotel_update
app_name = 'proapp18'
...
urlpatterns = [
    ...
    path(route='',view=hotel_view,name='hotel_register'),
    path(route='hotel_display/',view=hotel_display,name='hotel_display'),
    path(route='hotel_update/<int:pk>',view=hotel_update,name='hotel_name')
]
